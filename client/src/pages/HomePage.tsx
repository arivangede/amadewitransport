...
const VITE_CONTACT_NUMBER = import.meta.env.VITE_CONTACT_NUMBER;
...
function UnitList() {
  const { data: units, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.data as UnitWithRelations[];
    },
  });
...
function PackageList() {
  const { data: packages, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return res.data as PackageWithRelations[];
    },
  });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
            <div className="bg-gray-600 bg-opacity-10 rounded-lg p-8">
              ...
              <p className="text-2xl font-bold">{VITE_CONTACT_NUMBER}</p>
            </div>
            <div className="bg-gray-600 bg-opacity-10 rounded-lg p-8">
              <Mail className="h-12 w-12 mx-auto mb-4" />
              <h3 className="text-xl font-bold mb-2">Email Us</h3>
              <p className="text-yellow-100 mb-4">Quick response guaranteed</p>
              <p className="text-xl font-bold">{VITE_CONTACT_EMAIL}</p>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>{VITE_CONTACT_NUMBER}</li>
                <li>{VITE_CONTACT_EMAIL}</li>
