...
export function CarUnitCard({
  ...
  // Perbaiki konversi tipe data agar sesuai dengan array of objek {item, description}
...
// export default function UnitCard({ unit }: { unit: UnitWithRelations }) {
//   return (
//     <div className="flex items-center justify-between bg-background border rounded-md overflow-hidden border md:hover:border-foreground md:transition">
//       <div className="flex items-center gap-2">
//         <Image
//           alt="unit-image"
//           width={150}
//           height={150}
//           className="object-contain h-full min-h-[150px]"
//           src={
//             unit.images &&
//             unit.images[0] &&
//             typeof unit.images[0].path !== "undefined"
//               ? unit.images[0].path
...
//           <div>year: {unit.year}</div>
//           <div>base rate: IDR {unit.base_rate}/12hours</div>
//           <div>inclusions:</div>
//         </div>
//       </div>
